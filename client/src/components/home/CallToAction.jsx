    ...
    <section className="relative overflow-hidden">
      ...
      <div className="py-28 sm:py-36 bg-[#C2FE0B] relative">
        <div className="max-w-[900px] mx-auto px-8 sm:px-16 text-center relative z-10">
          {/* Tag discret */}
          <span className="inline-block font-mono text-[10px] tracking-[0.3em] text-[#000000]/50 uppercase mb-6">
            // DISPONIBLE
          </span>

          {/* Titre clean */}
          <h2 className="font-condensed font-black text-[#000000] text-[clamp(44px,9vw,100px)] leading-[0.9] uppercase mb-8">
            UN PROJET
            <br />
            EN TÊTE ?
          </h2>
          ...
          {/* Sous-titre */}
          <p className="font-mono text-[13px] sm:text-[14px] tracking-[0.08em] text-[#000000]/60 max-w-sm mx-auto mb-10">
          ...
          <Link
            to="/contact"
            className="group relative inline-flex items-center gap-3 px-8 py-4 bg-[#000000] text-[#C2FE0B] font-condensed font-bold text-[13px] sm:text-[14px] tracking-[0.15em] uppercase transition-all duration-300 hover:bg-white hover:text-[#000000]"
            style={{
      ...
      <div className="h-16 bg-[#000000] relative flex items-center justify-center gap-10 sm:gap-16 overflow-hidden">
