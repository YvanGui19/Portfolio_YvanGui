          ...
          <div className="flex flex-wrap justify-center gap-4">
            {(skills || []).map((skill, index) => (
              ...
              >
                ...
                <span aria-hidden="true" className="text-xs text-text-light absolute inset-0 flex items-center justify-center invisible opacity-0 [transition:opacity_300ms,transform_300ms,visibility_0s_300ms] group-hover:visible group-hover:opacity-100 group-hover:translate-y-5 group-hover:[transition:opacity_300ms,transform_300ms,visibility_0s] truncate px-1">
                  {skill.name}
                </span>
              </motion.div>
            ))}
