          ...
          <div className="flex flex-wrap justify-center gap-4">
            {(skills || []).map((skill, index) => (
              ...
              >
                ...
                <span className="text-xs text-text-light absolute inset-0 flex items-center justify-center opacity-0 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-5 truncate px-1">
                  {skill.name}
                </span>
              </motion.div>
            ))}
