          ...
          <div className="flex flex-wrap justify-center gap-4">
            {(skills || []).map((skill, index) => (
              ...
              >
                ...
                <span aria-hidden="true" className="text-xs text-text-light absolute inset-0 flex items-center justify-center invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-opacity duration-300 group-hover:translate-y-5 truncate px-1">
                  {skill.name}
                </span>
              </motion.div>
            ))}
